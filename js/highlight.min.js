...
subLanguage:"bash"}}]})})(); ("shell",s)})();/*! `sql` grammar compiled for Highlight.js 11.9.0 */
(()=>{var e=(()=>{"use strict";return e=>{
...
(() => {
  var vueLanguage = (() => {
    ...
    return function(hljs) {
      ...
      // 合并所有规则
      const contains = [templateRules, scriptRules, styleRules];
